...
-- Icon Data
zanncdwbl_Practical_Gods.Boon_Artemis_ArtemisCriticalBoon = sjson.to_object({
...
zanncdwbl_Practical_Gods.ArtemisCriticalBoon = sjson.to_object({
...
zanncdwbl_Practical_Gods.ArtemisCriticalBoon_Text = sjson.to_object({
